...
public class PostAPITest extends TestBase{
	...
	public void postAPITest() throws JsonGenerationException, JsonMappingException, IOException{
		...
		//Users users = new Users("morpheus", "leader", new String[]{"testing"});
		Users users = new Users("morpheus", "leader");
		
		//object to json file:
		mapper.writeValue(new File("E:\\Yuvaraj Learning\\Eclipse\\APIAutomationUsingHTTPClient\\src\\main\\java\\com\\qa\\data\\users.json"), users);
